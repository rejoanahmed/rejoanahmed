...
const Theme = ({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: apply selected theme function (light, dark, system)
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: Set theme state and save to local storage
  const setTheme = useCallback(
    // biome-ignore lint/suspicious/noExplicitAny: <explantion>
    (value: any) => {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: <explan\tion>
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies:localStorage event handling, allow to sync theme changes between tabs
  useEffect(() => {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: Whenever theme or forcedTheme changes, apply it
  useEffect(() => {
...
// biome-ignore lint/suspicious/noExplicitAny: <expanation>
