  ...
  return (
    <div className="relative text-justify">
      ...
      <div className="relative overflow-hidden">
        <AnimatedBlob />
        <div className="flex border-spacing-1 flex-wrap items-center justify-center gap-12 overflow-hidden rounded-2xl bg-white/10 p-4 backdrop-blur-2xl dark:bg-slate-600/10">
          <FaReact className="shrink-0 text-7xl text-sky-600" />
          ...
          <SiTypescript className="text-blue-320 shrink-0 text-7xl" />
          <svg
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-20 shrink-0 fill-black dark:fill-white"
            viewBox="0 0 256 256"
          >
          ...
          />
          <svg
            className="m-2 w-32 shrink-0 fill-[#2D3748] dark:fill-neutral-100"
            viewBox="0 0 90 28"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
